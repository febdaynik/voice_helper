...
class FinderVoice:
	def __init__(self, text):
		...
		self.trigger_word_task = [
			...
			"занят заданием",
			"получил задачу",
			"стал автором задания",
			"стал исполнителем задания",
			"начинает выполнение задания",
			"начинает выполнение задачи",
			"занимается задачей",
			"занимается выполнением задания",
			"работает над заданием",
			...
			"на начальной стадии выполнения задания",
			"на последней стадии выполнения задания",
			"на начальной стадии выполнения задачи",
			"на последней стадии выполнения задачи",
			"занят процессом выполнения задания",
			"в процессе выполнения задачи",
			"в процессе выполнения задания",
			"принялся за задание",
			"принялся за задачу",
			"немедленно принялся за задание"
			] 
